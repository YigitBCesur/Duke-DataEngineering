...
komutu eger git'te is yapiyorsaniz, Her git pull ve git push işleminde token ister —
Token'ı bir kez girdikten sonra otomatik kaydeder, bir daha sorulmaz.
Olmadan: her git push/pull da username + token girmek zorunda kalırsın.
Olduktan sonra: ilk girişten sonra /home/yigit/.git-credentials dosyasına kaydeder, otomatik kullanır.
bu kod sayesinde bir kez girince bir daha sormaz.

## export
Eğer terminali kapatırsan export ile tanımladığın food değişkeni uçar gider. 
